...
export default function Feature({type}) {
    return (
        ...
        <div className="info">
            ...
            <span className="desc">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto possimus unde aspernatur commodi, voluptas ducimus fugit dignissimos error praesentium voluptatibus blanditiis perspiciatis laborum magnam accusantium officiis. Amet consequuntur ullam excepturi?
